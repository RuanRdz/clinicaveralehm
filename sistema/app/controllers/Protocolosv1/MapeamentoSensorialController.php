...
class MapeamentoSensorialController extends BaseRelatorioController
{
    public function edit($id) {

        $t = Tratamento::findOrFail($id);
        $mapeamentoSensorial = Anamnese::bloco('A');
        $blocos = Anamnese::$blocos;
        $dados = Anamnesetratamento::dados($t);

        return View::make(
            'protocolos.mapeamentosensorial.form',
            compact('t', 'mapeamentoSensorial', 'blocos', 'dados')
        );
    }
    ...
    public function update() {
        ...
        return Redirect::route(
            'mapeamentosensorialEdit', array('id' => $post['tratamento_id'])
