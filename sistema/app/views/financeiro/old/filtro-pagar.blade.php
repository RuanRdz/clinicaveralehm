{{ Form::open(array('route' => 'financeiroPagar', 'class' => 'form', 'role' => 'form')) }}
<div id="modal_filtro_pagar" class="modal ui-front" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon bg-teal-200">Tipo Despesa</div>
                        {{
                        Form::select(
                            'tipodespesa_id', $filtroOptions['tipodespesa'],
                            Session::get('filtro_financeiro.tipodespesa_id'),
                            [
                                'class' => 'selectpicker show-tick show-menu-arrow form-control',
                                'data-live-search' => 'true'
                            ]
