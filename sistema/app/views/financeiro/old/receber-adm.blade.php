...
@section('content')
    @include('financeiro.filtro-receber-adm')
    <div ng-controller="ListRecursos">
        <div class="row mb-3 no-print">
            <div class="col-sm-8">
                ...
                <button
                    ...
                    data-toggle="modal" 
                    data-target="#modal_filtro_receber_adm"
                >
                    <i class="fa fa-filter"></i> Filtro
                </button>
                <a
                    href="{{ route('financeiroReceberAdmExcel') }}"
        ...
        <div class="bg-white shadow-md">
            <table class="table table-condensed table-bordered table-hover valign-middle">
                            ...
                            <td class="no-print">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                            <a href="#" ng-click="openModalForm('{{ route('financeiroEditReceberAdm', ['id' => $row->id]) }}')">
                ...
                <tfoot>
                    <tr>
                        <th colspan="6" class="text-right">Total {{ $total }}</thclass>
                    </tr>
                </tfoot>
            </table>
        </div>
