...
@section('main-panel-heading')
	...
	<ol class="breadcrumb">
		...
		<li class="active">Situações do tratamento</li>
	</ol>
@stop
            ...
            <div class="col-xs-16 col-lg-14 col-lg-offset-1">
                <div class="mb-3">
                    <button
                        ...
                        ng-click="openModalForm('{{route('tratamentosituacoesCreate')}}')"
                    >
                ...
                <div class="bg-white shadow-md">
                    <table class="table valign-middle border-0">
                        ...
                        <tbody>
                            @foreach($tratamentosituacoes as $row)
                                <tr 
                                    ng-click="openModalForm('{{route('tratamentosituacoesEdit', array('id' => $row->id))}}')"
